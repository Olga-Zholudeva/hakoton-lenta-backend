...
class SkuAdmin(admin.ModelAdmin):
    list_display = ('pr_sku_id', 'pr_group_id', 'pr_cat_id', 'pr_subcat_id',
                    'pr_uom_id')
    list_filter = ('pr_sku_id', 'pr_group_id', 'pr_cat_id', 'pr_subcat_id',
                   'pr_uom_id')
...
class StoreAdmin(admin.ModelAdmin):
    ...
    list_filter = ('st_id', 'st_city_id', 'st_division_code',
                   'st_type_format_id', 'st_type_loc_id',
                   'st_type_size_id', 'st_is_active')
...
class ForecastSkuAdmin(admin.ModelAdmin):
    ...
    list_filter = ('st_id', 'pr_sku_id', 'forecast_date')
...
class SalesAdmin(admin.ModelAdmin):
    ...
    list_filter = ('st_id', 'pr_sku_id', 'date', 'sales_type', 'sales_units',
                   'sales_units_promo', 'sales_rub', 'sales_run_promo')
